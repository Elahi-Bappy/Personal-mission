            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card shadow-2-strong card-registration mb-5" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5 ">
                        <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Registration Form</p></h3>
                        ...
                        <form method="POST" action="{{route('storeUser')}}">
                                @csrf
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input type="text" value="{{request()->first_name}}" name="first_name" id="firstName" class="form-control form-control-lg" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4 pb-2">
                                            <div class="form-outline">
                                                <input type="password" value="{{request()->password}}" name="password" id="phoneNumber" class="form-control form-control-lg" />
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <select class="select form-control-lg" name="user_type" value="{{request()->user_type}}">
